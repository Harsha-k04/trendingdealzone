  ...
  const products = [
    {
      ...
      rating: '4.4',
      link: 'https://www.amazon.in/s?k=boAt+Airdopes+141&tag=trendingd03db-21'
    },
    {
      id: 2,
      ...
      rating: '4.3',
      link: 'https://www.amazon.in/s?k=Noise+ColorFit+Pro+Smart+Watch&tag=trendingd03db-21'
    },
    {
      id: 3,
      ...
      category: 'Mobiles',
      rating: '4.8',
      link: 'https://www.amazon.in/s?k=Apple+iPhone+15&tag=trendingd03db-21'
    },
    {
      id: 4,
      ...
      category: 'Gaming',
      rating: '4.6',
      link: 'https://www.amazon.in/s?k=ASUS+TUF+Gaming+Laptop&tag=trendingd03db-21'
    },
    {
      id: 5,
      ...
      rating: '4.5',
      link: 'https://www.amazon.in/s?k=Prestige+Electric+Rice+Cooker&tag=trendingd03db-21'
    },
    {
      id: 6,
      ...
      category: 'Fitness',
      rating: '4.2',
      link: 'https://www.amazon.in/s?k=Fire-Boltt+Ninja+Fitness+Band&tag=trendingd03db-21'
    },
    {
      id: 7,
      ...
      rating: '4.7',
      link: 'https://www.amazon.in/s?k=Logitech+Wireless+Gaming+Mouse&tag=trendingd03db-21'
    },
    {
      id: 8,
      ...
      category: 'Audio',
      rating: '4.6',
      link: 'https://www.amazon.in/s?k=Sony+WH-CH520+Bluetooth+Headphones&tag=trendingd03db-21'
    },
    {
      id: 9,
      ...
      category: 'Mobiles',
      rating: '4.8',
      link: 'https://www.amazon.in/s?k=Samsung+Galaxy+S24+Ultra&tag=trendingd03db-21'
    },
    {
      id: 10,
      ...
      category: 'Laptops',
      rating: '4.5',
      link: 'https://www.amazon.in/s?k=HP+Victus+Gaming+Laptop&tag=trendingd03db-21'
    },
    {
      id: 11,
      ...
      category: 'Speakers',
      rating: '4.7',
      link: 'https://www.amazon.in/s?k=JBL+Flip+Bluetooth+Speaker&tag=trendingd03db-21'
    },
    {
      id: 12,
      ...
      category: 'Audio',
      rating: '4.3',
      link: 'https://www.amazon.in/s?k=realme+Buds+Wireless+3&tag=trendingd03db-21'
    },
    {
      id: 13,
      ...
      category: 'Kitchen',
      rating: '4.6',
      link: 'https://www.amazon.in/s?k=Philips+Air+Fryer&tag=trendingd03db-21'
    },
    {
      id: 14,
      ...
      category: 'Monitors',
      rating: '4.5',
      link: 'https://www.amazon.in/s?k=Dell+24+Inch+Monitor&tag=trendingd03db-21'
    },
    {
      id: 15,
      ...
      category: 'Accessories',
      rating: '4.4',
      link: 'https://www.amazon.in/s?k=MI+Power+Bank+20000mAh&tag=trendingd03db-21'
    },
    {
      id: 16,
      ...
      category: 'Smart Home',
      rating: '4.7',
      link: 'https://www.amazon.in/s?k=Amazon+Echo+Dot+5th+Gen&tag=trendingd03db-21'
    }
  ];
    ...
    <div className="min-h-screen bg-[#eaeded] text-gray-900 font-sans">
      ...
      <header className="sticky top-0 z-50 shadow-lg">
        ...
        <div className="bg-[#111827] text-white shadow-md">
          <div className="max-w-7xl mx-auto px-6 py-3 flex gap-6 overflow-x-auto text-sm font-medium">
            <a href="https://www.amazon.in/deals?tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Today's Deals</a>
            <a href="https://www.amazon.in/gp/bestsellers/?tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Best Sellers</a>
            <a href="https://www.amazon.in/electronics/b/?tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Electronics</a>
            <a href="https://www.amazon.in/video-games/b/?tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Gaming</a>
            <a href="https://www.amazon.in/Home-Kitchen/b/?tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Home & Kitchen</a>
            <a href="https://www.amazon.in/s?k=fitness+products&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Fitness</a>
            <a href="https://www.amazon.in/s?k=trending+products&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="hover:text-[#facc15] text-[#fde68a] whitespace-nowrap">Trending Finds</a>
          </div>
        </div>
      </header>
          ...
          {[
            {
              name: 'Electronics',
              icon: '📱',
              link: 'https://www.amazon.in/s?k=electronics&tag=trendingd03db-21'
            },
            {
              name: 'Fitness',
              icon: '⌚',
              link: 'https://www.amazon.in/s?k=fitness+products&tag=trendingd03db-21'
            },
            {
              name: 'Gaming',
              icon: '🎮',
              link: 'https://www.amazon.in/s?k=gaming+accessories&tag=trendingd03db-21'
            },
            {
              name: 'Home',
              icon: '🏠',
              link: 'https://www.amazon.in/s?k=home+kitchen&tag=trendingd03db-21'
            }
          ].map((category) => (
            <a
              key={category.name}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-200">
            ...
            <div className="p-5">
              ...
              <a href="https://www.amazon.in/s?k=best+smartphones&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="text-[#ff9900] font-bold hover:underline">Read More</a>
            </div>
          </article>
          ...
          <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-200">
            ...
            <div className="p-5">
              ...
              <a href="https://www.amazon.in/s?k=best+selling+books&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="text-[#ff9900] font-bold hover:underline">Read More</a>
            </div>
          </article>
          ...
          <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-200">
            ...
            <div className="p-5">
              ...
              <a href="https://www.amazon.in/s?k=latest+electronics&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="text-[#ff9900] font-bold hover:underline">Read More</a>
            </div>
          </article>
          ...
          <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-200">
            ...
            <div className="p-5">
              ...
              <a href="https://www.amazon.in/s?k=gaming+accessories&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="text-[#ff9900] font-bold hover:underline">Read More</a>
            </div>
          </article>
          ...
          <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-200">
            ...
            <div className="p-5">
              ...
              <a href="https://www.amazon.in/s?k=best+gadgets+under+1000&tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="text-[#ff9900] font-bold hover:underline">Read More</a>
            </div>
          </article>
          ...
          <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-200">
            ...
            <div className="p-5">
              ...
              <a href="https://www.amazon.in/deals?tag=trendingd03db-21" target="_blank" rel="noopener noreferrer" className="text-[#ff9900] font-bold hover:underline">Read More</a>
            </div>
          </article>
        </div>
      </section>
      ...
      <footer id="contact" className="bg-[#131a22] text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 items-start">
          <div>
            <h4 className="text-2xl font-bold text-white mb-4">TrendingDealZone.com</h4>
            <p>
          ...
          <a href="https://www.amazon.in/" target="_blank" rel="noopener noreferrer">
            <img src="/ChatGPT Image May 25, 2026, 04_49_02 PM(1).png" alt="Footer Logo" className="h-14 object-contain" />
          </a>
        </div>
      </footer>
    </div>
